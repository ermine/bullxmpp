...
let _ =
  ...
  let omg = zip [] (prohibits, bidi) in
    ...
    printf "  b_b1 = 0\n";
    printf "  b_mc = 1\n";
    printf "  b_nameprep_prohibit = 1\n";
    printf "  b_resourceprep_prohibit = 2\n";
    printf "  b_nodeprep_prohibit = 4\n";
    printf "  b_randal = 8\n";
    printf "  b_l = 16\n";
    printf "  casemap_max_idx = %d\n" (List.length blocks - 1);
    printf "  prohibits_max_idx = %d\n" (List.length omg - 1);
    printf ")\n\n";

    printf "var fmap = [][]rune{\n";
    List.iter (fun c ->
     printf "  {";
    ...
    printf "var casemap = [][]rune{\n";
    List.iter (fun c ->
      printf "  {%d, %d, %d},\n" c.(0) (c.(1)-1) c.(2)
    ) (blocks);
    printf "}\n\n";

    printf "var prohibits = [][]rune{\n";
    List.iter (fun c ->
      printf "  {%d, %d, %d},\n" c.(0) (c.(1)-1) c.(2)
    ) omg;
    printf "}\n"
